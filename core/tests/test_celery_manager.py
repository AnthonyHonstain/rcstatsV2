...
Echo, Jon            #1          1           35.952         35.952
 ...
 ------- ------- ------- ------- ------- ------- ------- ------- ------- -------
    ...
    def test_celery_manager(self):
        single_race_detail = SingleRaceDetails.objects.get(pk=1)        

        # TODO - clean this up, why is there a user hanging around?
        # TODO - don't they get automatically blasted with the DB cleanup between tests?
        ...
        with mock.patch('core.celery_manager._mail_single_race') as mail_single_race:
            ...
            mail_single_race.assert_called_with(user, single_race_detail)
