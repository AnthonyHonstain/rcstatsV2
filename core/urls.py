...
urlpatterns = [
    ...
    url(r'racer-list/(?P<track_id>\d+)/racerid/(?P<racerid_id>\d+)/$', views.single_racer, name='single_racer'),
    url(r'racer-list/(?P<track_id>\d+)/racerid/(?P<racerid_id>\d+)/history/$', views.single_racer_race_list, name='single_racer_race_list'),
